...
exports.V2andV3 = void 0;
var V2andV3 = /** @class */ (function () {
    function V2andV3() {
    }
    V2andV3.attestationTypesConverter = function (x) {
    ...
    V2andV3.userVerificationDetailsConverter = function (x) {
        //controllo tipo: se number si ritorna il nome dell'algoritmo
        if (typeof x === "number") {
    ...
    V2andV3.keyProtectionConverter = function (x) {
        //controllo tipo: se number si ritorna il nome dell'algoritmo
        if (typeof x === "number") {
    ...
    V2andV3.matcherProtectionConverter = function (x) {
        //controllo tipo: se number si ritorna il nome dell'algoritmo
        if (typeof x === "number") {
    ...
    V2andV3.attachmentHintConverter = function (x) {
        //controllo tipo: se number si ritorna il nome dell'algoritmo
        if (typeof x === "number") {
    ...
    V2andV3.tcDisplayConverter = function (x) {
        //controllo tipo: se number si ritorna il nome dell'algoritmo
        if (typeof x === "number") {
    ...
    V2andV3.authenticationAlgorithmsConverter = function (x) {
        //controllo tipo: se number si ritorna il nome dell'algoritmo
        if (typeof x === "number") {
    ...
    V2andV3.publicKeyAlgAndEncodingsConverter = function (x) {
        //controllo tipo: se number si ritorna il nome dell'algoritmo
        if (typeof x === "number") {

...
import { AuthenticatorGetInfo } from './converter/models/Keys/fields/AuthenticatorGetInfo';
...
let m = metadataInitializer(path.join(__dirname, "../resources/FIDOV3Keys.txt"));
